...
### Файли та продакшн-зберігання

- Шлях для завантажень (чеки, довідки) задається змінною `UPLOAD_ROOT`. За замовчуванням файли пишуться в `public/uploads/`, але для хостингу вкажіть абсолютний шлях на файловій системі сервера, щоб відокремити статику від коду.
